# 004. Les valvulopathies aortiques : diagnostic et prise en charge

Rétrécissement aortique (RAo)
Introduction :
= Obstacle à l'éjection du VG par réduction de la surface valvulaire aortique normale à moins de 3cm2 . (RAo serré si< 0, 75cm2
)
...
*  Puis symptômes d'effort+++: angor, syncope ou lipothymie, dyspnée.
...
- Souffle mésa systolique éjectionnel +++ max au foyer aortique, rude râpeux à double irradiation vers les vaisseaux du cou et vers la pointe.
- Diminution voir extinction du B2 aortique (signe de gravité).
3) Paraclinique :
❖ ECG:
■ HVG type systolique :
o Sokolow = RVl + SVS > 35 mm
o Onde T (-) en VS-V6
■ HAG - BBG incomplet (BBGI) parfois BBG complet.
■ BAV: 1•' voire 2ème, lm• degré si calcification fx de His.
❖ Radio pulmonaire :
■ Volume du cœur longtemps normal.
■ Calcification valvulaire aortique.
■ Aorte ascendante dilaté : l'arc sup droit très convexe.
❖ Echocardioqraphie :
■ Confirme un diagnostic clinique: Epaississement ou Calcification des valves dont l'ouverture est diminuée.
...
> Signes fonctionnelles d'effort -Abolition du B2
> HVG importante/ECG - Calcification valvulaire massive
> Gradient de pression moyenne VG /aorte> S0mmHg.
> Surface valvulaire aortique< 0, 75cm2 .
...
- Prothèse bio (âge> 75ans ou Cl des anticoagulants)
...
Introduction :
= Absence ou insuffisance d'étanchéité diastolique des sigmoïdes aortique à l'origine d' un reflux d' une certaine quantité de sang de l'aorte vers le VG en diastole.
Etiologies :
■ IAo chronique: RAA, maladie de Marfan , endocardite infectieuse, inflammatoire, congénitale ...
...
■ L'angor, plus rare mais de signification pronostic grave.
...
- Signes associés: Souffle éjectionnel mésosystolique, claquement d' éjection mésosystolique, roulement
...
o Sokolow > à 35 mm
o Grandes ondes R en VS-V6
o Onde Q fine parfois profonde en VS-V6
■ Surcharge systolique (tardive) : onde T(-) en VS-V6.
❖ Radiographie pulmonaire :
■ Insuffisance aortique chronique: Cardiomégalie/dilatation VG et débord de l'arc sup droit.
■ Insuffisance aortique aiguë: Pas de cardiomégalie.
■ Signes de congestions pleuraux pulmonaires : OAP.
❖ Echocardioqraphie Doppler (ETT, ETO) :
■ Diagnostic positif de l'IAo ;
■ Quantification de l' IAo (degré d' IAo);
■ Cause et mécanisme de l'IAo
■ Retentissement de l' IM : (aorte, DTD VG, DTS VG, FE VG, PAPs)
■ Valvulopathies associées.
❖ Autres:
- Angiographie sus sigmoïdienne: Taille de l' aorte (éventuelle dilatation anévrysmale de l' aorte ascendante).
...
- Scanner - IRM : Taille de l'aorte ascendante dans les IAo dystrophiques et suivi de l' évolution.
...
- Vasodilatateurs type IEC (en l'absence d' IC) : permettent de différer la date de l' intervention dans l' IAo chronique
volumineuse asymptomatique, à fonction systolique conservée.
- Prévention oslerienne +++.
- Ttt influant sur dilatation de l'aorte: bêtabloquants+++, sauf si IAo imp. car allonge diastole et 1' régurgitation .
*  Chirurgie :
...
- Toute IAo importante symptomatique, sauf Cl liée au terrain (âge, tare), ou dysfonction VG majeure.
- IAo volumineuse asymptomatique, avec retentissement net (Dilatation du VG, '1, FE, évolutivité des paramètres++
...
3) Surveillances postopératoire: +++
*  Clinique:
- Signes fonctionnels
